...
#image_dataset = load_image_files(os.getcwd()+"/Experiments/data/segmented_unet/")
#image_dataset = load_image_files(os.getcwd()+"/Experiments/data/segmented_kmeans/")
#image_dataset = load_image_files(os.getcwd()+"/Experiments/data/segmented_flood/")
#%%
print(image_dataset)
...
x_test_cnn = transform(x_test)
x_train_cnn = transform(x_train)  
