...
from keras.layers import Model, Input, Conv2D, MaxPooling2D, concatenate, Conv2DTranspose
...
#%% Specify directory of images and masks
DIR="data/segmentation masks/"
...
for img_path in lung_image_paths:
    ...
    img_match = re.search("CXR_png/([a-zA-Z0-9]*_[a-zA-Z0-9]*_[a-zA-Z0-9]*).png$", img_path)
    if img_match:
...
coef(y_true = mask_test[IMG_NUM], y_pred = prediction)
